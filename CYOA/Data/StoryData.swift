...
var story = [
    StoryModel(id: 0,
               ...
               button1action: 1,
               diceRoll1: [trait.charisma],
               button2text: "Go to Page 2",
               button2Action: 2,
               button3Text: "Go to page 3",
               button3Action: 3,
               button4Text: "Go to Page 4",
               button4Action: 4),
    StoryModel(id: 1,
               text: "This is page 1",
               rollTheDice: true,
               button1Text: "Go back to page 0",
               button1action: 0,
               diceRoll1: [trait.combat, trait.diplomacy],
               button2text: "Go to Page 2",
               button2Action: 2,
               button3Text: "Go to Page 3",
               button3Action: 3,
    ...
    StoryModel(id: 2,
               text: "This is page 2",
               rollTheDice: false,
               button1Text: "Go to page 0",
               button1action: 0,
               diceRoll1: [0],
               button2text: "Go to page 1",
               button2Action: 1,
               button3Text: "Go to page 3",
               button3Action: 3,
               button4Text: "Go to page 4",
    ...
    StoryModel(id: 4,
        ...
        """,
               rollTheDice: false,
               button1Text: "Go to page 0",
               button1action: 0, diceRoll1: [0],
               button2text: "Go to page 1",
               button2Action: 1,
               button3Text: "Go to page 2",
               button3Action: 2,
               button4Text: "Go back to page 3",
               button4Action: 3)
]
