...
class StoryModel {
    ...
    init(id: Int, text: String, button1Text: String, button1action: Int, button2text: String, button2Action: Int, button3Text: String, button3Action: Int, button4Text: String, button4Action: Int) {
        self.id = id
        self.text = text
